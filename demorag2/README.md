...
**The demo includes a beautiful web interface!**

After running the demo, access the web app:
...
- See RAG process in action (step-by-step)
- View retrieved products with similarity scores
- Get AI-generated answers with full context
- Expand to see exact prompt sent to LLM
...
- Learn how vector search works
- Understand key concepts
- See benefits and use cases

**📈 Analytics Tab**
- Products by category (bar charts)
- Price distribution graphs
- Stock level visualization
- Scatter plots and trends
- Detailed category breakdowns

See [WEBAPP_GUIDE.md](WEBAPP_GUIDE.md) for the complete user guide.
